...
package struct Formatter {
    ...
    package func format(captureGroup: any CaptureGroup) -> String? {
        ...
        case let group as AppIntentsNLTrainingProcessorCaptureGroup:
            return renderer.formatAppIntentsNLTrainingProcessor(group: group)
        ...
        case let group as BuildPhasePlumbingCaptureGroup:
            return renderer.formatBuildPhasePlumbing(group: group)
        ...
        case let group as FatalErrorCaptureGroup:
            return renderer.formatError(group: group)
        case let group as FatalErrorWithFilePathCaptureGroup:
            return renderer.formatFatalErrorWithFilePath(group: group)
        ...
        case let group as SwiftExplicitDependencyGeneratePcmCaptureGroup:
            return renderer.formatSwiftExplicitDependencyGeneratePcm(group: group)
